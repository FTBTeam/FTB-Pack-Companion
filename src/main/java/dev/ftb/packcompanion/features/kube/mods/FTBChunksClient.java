...
public class FTBChunksClient {
    ...
    private final Map<Identifier, ResourceKey<Level>> dimensionIdToResourceKeyMap = new HashMap<>();
    ...
    public WaypointManager waypointManagerForDimId(Identifier dimensionId) {
